...
class StatusTransitionConfigTest {
    ...
    @Test
    void testDefaultConstructorAndNoTransitions() {
        StatusTransitionConfig config = new StatusTransitionConfig();
        assertFalse(config.isValidTransition("anyType", "anyStatus", "anyNewStatus"));
    }
}
